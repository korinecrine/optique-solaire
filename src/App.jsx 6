...
export default function StockApp() {
  ...
  // ---------- Bilan entreprise (toutes villes) ----------
  ...
  const beneficeApresPertes = bilan.benefice - pertesLivraisonRatee;

  // Comparateur de mois : cumule toujours toutes les ventes, indépendamment du filtre de période ci-dessus.
  ...
  // Classement des modèles sur la période du bilan sélectionnée.
    ...
    <div style={styles.page}>
      ...
      <header style={styles.header}>
        <div style={styles.brandRow}>
          ...
          <div>
            <h1 style={styles.brandName}>Optique Solaire</h1>
          ...
          <div style={styles.payslipWrap} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={styles.payslipPaper} id="payslip-paper">
              <div style={styles.payslipHeader}>
                <div>
                  <div style={styles.payslipBrand}>Optique Solaire</div>
            ...
            <div style={{ padding: 20 }}>
              ...
              <section style={{ ...styles.statsRow, marginTop: 6 }}>
                ...
                <StatCard
                  ...
                  label={`Pertes livraison ratée (${bilanEchecs.length})`}
                  value={fmtFCFA(pertesLivraisonRatee)}
                  warn={pertesLivraisonRatee > 0}
                />
              </section>

              <div style={styles.bilanTotalCard}>
                <div style={styles.bilanTotalLabel}>Bénéfice total généré par l'entreprise</div>
                <div style={styles.bilanTotalValue}>{fmtFCFA(beneficeApresPertes)}</div>
                {pertesLivraisonRatee > 0 && (
                  <div style={styles.bilanTotalSub}>({fmtFCFA(bilan.benefice)} avant pertes de livraison)</div>
                )}
              </div>

              <h3 style={styles.bilanSectionTitle}>Comparateur de mois</h3>
              <p style={styles.bilanNote}>Toujours sur les 12 derniers mois, indépendamment de la période choisie ci-dessus.</p>
              ...
              <p style={styles.bilanNote}>Sur la période sélectionnée ci-dessus.</p>
